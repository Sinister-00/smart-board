...
import {Dice} from '@server/lib/ludo/containers/Dice/Container';
import {IBase} from '@server/lib/ludo/containers/Ludo/state/interfaces';
...
export const Player = connect(mapStateToProps as any)(PlayerBare) as unknown as React.ComponentClass<IPublicProps>;
