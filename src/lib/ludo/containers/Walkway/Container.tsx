...
import {flatArray} from '@server/lib/ludo/common/utils';
import {Coin} from '@server/lib/ludo/containers/Base/components/Coin';
import {isDieRollValidSelector} from '@server/lib/ludo/containers/Dice/state/selectors';
import {moveCoin} from '@server/lib/ludo/containers/Ludo/state/actions';
import {CellType, ICell, ICoin, IServerGameData, IWalkway} from '@server/lib/ludo/containers/Ludo/state/interfaces';
import {basesSelector, cellsSelector, coinsSelector, currentTurnSelector, linksSelector} from '@server/lib/ludo/containers/Ludo/state/selectors';
import {getStyleObject} from '@server/lib/ludo/containers/utils';
import {COIN_SIZE, WALKWAY_LENGTH, WALKWAY_WIDTH} from '@server/entities/ludo-constants';
import {hideContextMenu, showContextMenu} from '@server/lib/ludo/services/contextMenu/service';
...
export const Walkway = connect(mapStateToProps as any, mapDispatchToProps)(WalkwayBare) as unknown as React.ComponentClass<IPublicProps>;
