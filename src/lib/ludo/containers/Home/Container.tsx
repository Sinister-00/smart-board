...
import {IRelationship} from '@server/lib/ludo/containers/Ludo/state/interfaces';
import {basesSelector} from '@server/lib/ludo/containers/Ludo/state/selectors';
import {getBaseHexColor, getStyleObject} from '@server/lib/ludo/containers/utils';
import {CELL_DIMENSION, HOME_SIZE} from '@server/entities/ludo-constants';
...
export const Home = connect(mapStateToProps as any)(HomeBare) as unknown as React.ComponentClass<IPublicProps>;
