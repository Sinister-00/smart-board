...
import {Base} from '@server/lib/ludo/containers/Base/Container';
import {Home} from '@server/lib/ludo/containers/Home/Container';
import {Player} from '@server/lib/ludo/containers/Player/Container';
import {Walkway} from '@server/lib/ludo/containers/Walkway/Container';
import {getBoardStyles} from '@server/lib/ludo/containers/utils';
import {BOARD_SIZE} from '@server/entities/ludo-constants';
import {ContextMenu} from '@server/lib/ludo/services/contextMenu/Container';
    ...
    return (
      <div className={styles.Container}>
        <div className={styles.GameContainer}>
          ...
          <div className={styles.Board} style={getBoardStyles(BOARD_SIZE, BOARD_SIZE)}>
            {
...
export const Ludo = connect(mapStateToProps as any, mapDispatchToProps)(LudoBare) as unknown as React.ComponentClass<IPublicProps>;
