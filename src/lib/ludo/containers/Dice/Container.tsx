...
import {DICE_SIZE} from '@server/entities/ludo-constants';
...
export const Dice = connect(mapStateToProps as any, mapDispatchToProps)(DiceBare) as unknown as React.ComponentClass<IPublicProps>;
