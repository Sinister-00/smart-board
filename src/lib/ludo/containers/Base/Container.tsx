...
import {spawnCoin} from '@server/lib/ludo/containers/Ludo/state/actions';
import {IBase, ICoin} from '@server/lib/ludo/containers/Ludo/state/interfaces';
import {basesSelector, coinsSelector} from '@server/lib/ludo/containers/Ludo/state/selectors';
import {getStyleObject} from '@server/lib/ludo/containers/utils';
import {BASE_SIZE, INNER_BASE_SIZE} from '@server/entities/ludo-constants';
...
export const Base = connect(mapStateToProps as any, mapDispatchToProps)(BaseBare) as unknown as React.ComponentClass<IPublicProps>;
