...
// NAMESPACE OBJECT: ./src/app/game/register-board/route.ts
...
;// CONCATENATED MODULE: ./src/app/game/register-board/route.ts
...
async function POST(request) {
    try {
        ...
        const board = new models_board/* default */.Z({
...
const routeModule = new AppRouteRouteModule({
    definition: {
        ...
        page: "/game/register-board/route",
        pathname: "/game/register-board",
        filename: "route",
...
const originalPathname = "/game/register-board/route";
